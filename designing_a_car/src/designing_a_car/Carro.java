...
public class Carro {
    ...
    int velocidadeMax, numMarchas, capacidadeTanque, marchaAtual;
    ...
    public Carro(String nome, String nrDeModelos, String anoLancamento, String codigoIdentificador,
                 String modelo, String cor, String chassi, String proprietario, 
    ...
    public void setMarcha(int newMarcha){
        ...
        if(abs <= 2) if(newMarcha <= 6 && newMarcha >= 0) this.marchaAtual = newMarcha;
    }
